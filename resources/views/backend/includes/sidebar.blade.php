        ...
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown {{
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{
                                active_class(Active::checkUriPattern('library/book*'))
                            }}" href="{{ url('library/book') }}">
            ...
            <li class="nav-item nav-dropdown {{
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{
                                active_class(Active::checkUriPattern('account/menu1/*'))
                            }}" href="#">
                            <i class="fa fa-book"></i> Menu 1
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{
                                active_class(Active::checkUriPattern('account/menu2/*'))
                            }}" href="#">
                            <i class="fa fa-book"></i> Menu 2
                        </a>
                    </li>
                </ul>
            </li>
